...
<p>By default the root directory will navigate to the <a href="<?php $framework->route(array('controller'=>'example','method'=>'index'))?>">/example/index/</a> page. You can choose to change this in the index.php page.</p>
